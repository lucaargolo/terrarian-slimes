package io.github.lucaargolo.terrarianslimes.client.render.entity.model
...
class SpikedSlimeEntityModel: EntityModel<ModdedSlimeEntity>() {
    ...
    init {
        ...
        spike5.setTextureOffset(14, 14).addCuboid(-2.2813F, -1.277F, 0.0593F, 1.0F, 1.0F, 1.0F, 0.0F, false)

        spike6 = ModelPart(this)
        spike6.setPivot(0.0F, 1.0F, 3.0F)
        bone2.addChild(spike6)
        spike6.setRotation(1.0187F, -0.2409F, 0.806F)
        spike6.setTextureOffset(14, 14).addCuboid(-1.9771F, -2.6537F, -1.5187F, 1.0F, 1.0F, 1.0F, 0.0F, false)

        spike7 = ModelPart(this)
        spike7.setPivot(0.0F, 0.0F, 2.0F)
        bone2.addChild(spike7)
        spike7.setRotation(0.491F, 0.4079F, 0.8458F)
        spike7.setTextureOffset(12, 12).addCuboid(-2.1033F, -1.4329F, -1.3095F, 2.0F, 2.0F, 2.0F, 0.0F, false)

        spike8 = ModelPart(this)
        spike8.setPivot(0.0F, -1.0F, 4.0F)
        bone2.addChild(spike8)
        spike8.setRotation(0.3568F, 0.5351F, 0.7846F)
        spike8.setTextureOffset(14, 14).addCuboid(-0.8923F, -0.211F, -0.4096F, 1.0F, 1.0F, 1.0F, 0.0F, false)
        ...
        spike9.setTextureOffset(14, 14).addCuboid(-1.5826F, -1.0917F, -0.4981F, 1.0F, 1.0F, 1.0F, 0.0F, false)

        spike10 = ModelPart(this)
        spike10.setPivot(0.0F, 0.0F, 2.0F)
        bone3.addChild(spike10)
        spike10.setRotation(0.491F, 0.4079F, 0.8458F)
        spike10.setTextureOffset(12, 12).addCuboid(-1.4163F, -0.7081F, -1.3604F, 2.0F, 2.0F, 2.0F, 0.0F, false)

        spike11 = ModelPart(this)
        spike11.setPivot(0.0F, -1.0F, 4.0F)
        bone3.addChild(spike11)
        spike11.setRotation(0.2426F, 0.6248F, 0.7219F)
        spike11.setTextureOffset(14, 14).addCuboid(-1.5F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false)
