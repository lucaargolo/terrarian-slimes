...
class SpikedSlimeOverlayFeatureRenderer(context: FeatureRendererContext<ModdedSlimeEntity, SpikedSlimeEntityModel>): FeatureRenderer<ModdedSlimeEntity, SpikedSlimeEntityModel>(context) {
