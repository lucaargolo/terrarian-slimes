package io.github.lucaargolo.terrarianslimes.common.item.summonable
...
class SummonableItem(private val entityType: EntityType<*>, settings: Settings): Item(settings) {
    ...
    override fun use(world: World, user: PlayerEntity, hand: Hand): TypedActionResult<ItemStack> {
        ...
        if(!world.isClient) {
            ...
            user.sendMessage(TranslatableText("terrarianslimes.summonable_awoken", entity.displayName).formatted(Formatting.DARK_PURPLE), false)
        }
